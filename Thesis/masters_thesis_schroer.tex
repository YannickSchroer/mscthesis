...
\input{includes/figures/two_connected_neurons}
\vspace{-0.2cm}
...
\input{includes/figures/sigmoid}
...
\input{includes/figures/modified_sigmoid}
...
\input{includes/figures/functioning_cnn}
...
\input{includes/figures/cnn_maps}
...
\input{includes/figures/max_pooling}
...
\input{includes/figures/example_cnn}\\
...
\input{includes/figures/merge_real_imag}
...
\input{includes/figures/merge_abs_atan2}
...
\input{includes/figures/complete_gabor_cnn}\\
...
\input{includes/tables/cnn_errors_color_vs_gray}
...
\input{includes/tables/cnn_errors_96_vs_120}
...
\input{includes/tables/cnn_errors_480_96_vs_120}
...
\input{includes/tables/cnn_params_120_network}
...
\input{includes/tables/cnn_errors_uniform}
...
\input{includes/tables/cnn_errors_learningrates}
...
\input{includes/tables/cnn_errors_learningrates_more_epochs}
...
\input{includes/tables/cnn_errors_activation_functions}
...
\vspace{-0.6cm}
\input{includes/tables/cnn_params_learningrate_0.2}
%ReLU: 15261\\
%tanh: 15108\\
...
%TODO Show images with predictions for the best CNN
...
\input{includes/figures/merge_real_imag_one_size}
...
\input{includes/figures/complete_gabor_layer}
