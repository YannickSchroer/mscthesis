...
weight_store_path = "weights/gabor_lr0.1_absatan2_hd_gray_linear_dropout05"
...
with open("results/gabor_lr0.1_absatan2_hd_gray_linear_dropout05/results_1000.dat", "w") as loss_file:
